...
Dabei ist dp die oben beschriebene Tabelle als zweidimensionale Liste 
...
Um den Wert d$p[i][j]$ zu berechnen vergleicht der Algorithmus den 
gesamten Profit, um zu entscheiden ob er den Gegenstand aufnimmt (erster Funktionsaufruf in max\ ()), 
...
Berechnung, falls schon ein Wert in $dp[i][j]$ eingetragen ist (Prinzip der 
...
kann auch durch folgende Formel ausgedrückt werden:
